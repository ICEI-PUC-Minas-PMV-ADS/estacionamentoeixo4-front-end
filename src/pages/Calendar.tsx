        ...
        <table className="w-full">
          <thead>
            <tr className="grid grid-cols-7 text-white rounded-t-sm bg-primary">
              <th className="flex items-center justify-center p-1 text-xs font-semibold rounded-tl-sm h-15 sm:text-base xl:p-5">
                <span className="hidden lg:block"> Sunday </span>
                <span className="block lg:hidden"> Sun </span>
              </th>
              <th className="flex items-center justify-center p-1 text-xs font-semibold h-15 sm:text-base xl:p-5">
              ...
              <th className="flex items-center justify-center p-1 text-xs font-semibold rounded-tr-sm h-15 sm:text-base xl:p-5">
          ...
          <tbody>
            ...
            <tr className="grid grid-cols-7">
              <td className="relative h-20 p-2 transition duration-500 border cursor-pointer ease border-stroke hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-25 md:p-6 xl:h-31">

              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      className="flex justify-center px-6 py-2 font-medium rounded bg-primary text-gray hover:shadow-1"
                      type="submit"
                    >
                      Save
                    </button>
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="flex justify-end gap-4.5">
                    ...
                    <button
                      className="flex justify-center px-6 py-2 font-medium rounded bg-primary text-gray hover:bg-opacity-70"
                      type="submit"
                    >
                      Save
                    </button>
